...
const translations = {
  en: {
    ...
    desc_book10: "The Witcher: Sword of Destiny is a collection of short stories from the Witcher universe, following Geralt of Rivia's adventures in a world filled with magic and monsters. Each story reveals aspects of the Witcher's character and his challenges in a world where the line between good and evil is blurred.",
    desc_book11: "The Witcher: The Last Wish is the first collection of Witcher stories, introducing the world of Geralt of Rivia. The stories follow the Witcher's adventures in a world filled with magic and monsters, where he must make difficult decisions between good and evil in a morally gray world.",
    desc_book12: "The Unsolved Case Files of Sherlock Holmes presents a collection of mysterious cases that Sherlock Holmes has yet to solve. Be Sherlock Holmes' personal assistant and help him solve 24 intriguing puzzles. Each case requires logical thinking and clever solutions.",
    desc_book13: "Be the Person Who Makes You Happy is a motivational guide for finding happiness from within. The book explains that true happiness comes from self-acceptance and self-love, not from depending on others or external circumstances. A powerful message about self-discovery and inner contentment.",
    desc_book14: "Conversations on Love is a collection of deep and intelligent conversations about love in all its forms. The book explores romantic love, family love, friendship, and self-love through dialogues with experts and thinkers. A contemplative journey into the nature of human love.",
    desc_book15: "Jacob's Oasis is a spiritual novel about finding inner peace and spiritual renewal. The story follows characters as they discover an oasis that represents hope, transformation, and the possibility of starting over.",
    desc_book16: "The Horror is a deep psychological horror novel dealing with human inner fears and existential terror. The story follows a character facing their real nightmares in a world where fear becomes a tangible reality. A fascinating exploration of the human mind and its limits.",
  },
  ar: {
    HOME: "الرئيسية",
    PAGES: "الصفحات",
    ...
    desc_book10: "مجموعة قصص قصيرة من عالم الويتشر، تتبع مغامرات جيرالت من ريفيا في عالم مليء بالسحر والوحوش. كل قصة تكشف جانباً من شخصية الويتشر وتحدياته في عالم حيث الخط الفاصل بين الخير والشر ضبابي.",
    desc_book11: "المجموعة الأولى من قصص الويتشر، تقدم مقدمة لعالم جيرالت من ريفيا. تتبع القصص مغامرات الويتشر في عالم مليء بالسحر والوحوش، حيث يجب عليه اتخاذ قرارات صعبة بين الخير والشر في عالم رمادي.",
    desc_book12: "مجموعة من القضايا الغامضة التي لم يحلها شيرلوك هولمز بعد. كن مساعد شيرلوك هولمز الشخصي وساعده في حل 24 لغزاً محيراً. كل قضية تتطلب تفكيراً منطقياً وحلولاً ذكية.",
    desc_book13: "دليل تحفيزي للبحث عن السعادة من الداخل. يوضح الكتاب أن السعادة الحقيقية تأتي من قبول الذات وحب النفس، وليس من الاعتماد على الآخرين أو الظروف الخارجية. رسالة قوية عن اكتشاف الذات والرضا الداخلي.",
    desc_book14: "مجموعة من المحادثات العميقة والذكية حول الحب في جميع أشكاله. يستكشف الكتاب الحب الرومانسي، حب الأسرة، حب الأصدقاء، وحب الذات من خلال حوارات مع خبراء ومفكرين. رحلة تأملية في طبيعة الحب الإنساني.",
    desc_book15: "واحة يعقوب رواية روحية عن إيجاد السلام الداخلي والتجديد الروحي. تتبع القصة شخصيات تكتشف واحة تمثل الأمل والتحول وإمكانية البدء من جديد.",
    desc_book16: "رواية رعب نفسي عميقة تتعامل مع مخاوف الإنسان الداخلية والرعب الوجودي. تتبع القصة شخصية تواجه كوابيسها الحقيقية في عالم حيث يصبح الخوف حقيقة ملموسة. استكشاف مذهل للعقل البشري وحدوده.",
  }
};
